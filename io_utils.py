...
def load_model_outputs(filename: str) -> List[ModelOutput]:
    ...
    #IDS = [examples.index(example) for example in examples if any(score is None for score in example.scores.values())]
    #print(f'Done loading {len(filtered_examples)} ({len(examples)} before filtering) examples from file "{filename}"')
    #return filtered_examples
    
    print(f'Done loading {len(examples)} examples from file "{filename}"')
    return examples
