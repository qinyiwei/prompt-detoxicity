...
@click.command()
@click.option('--rates', required=True, multiple=True, type=int, help='')
def main(rates: int):
    weights_path = "/projects/tir4/users/yiweiq/toxicity/prompt-detoxicity/models/pplm_classifiers/toxicity_classifierhead_1280/toxic_classifier_head_epoch_10.pt"
    meta_path = "/projects/tir4/users/yiweiq/toxicity/prompt-detoxicity/models/pplm_classifiers/toxicity_classifierhead_1280/toxic_classifier_head_meta.json"

    # Create output files
    output_dir = '/projects/tir4/users/yiweiq/toxicity/dataset/DExperts/datasets/jigsaw-unintended-bias-in-toxicity-classification/'
    output_dir = Path(output_dir)
    batch_size = 32

    generations_file = output_dir / 'safe_all.txt'
